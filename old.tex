...
\cventry{September 2025}{Lead Software Engineer}{MIC Customs GmbH}{Linz (Austria)}{}{An international software company developing customs calculation software for international supply chains. \textit{\href{mic-cust.com}{mic-cust.com}}
\begin{itemize}
    \item Leading a 5-people team responsible for the Origin Calculation product for the EU customer (core product of the company).
    \item Lead the development in Java of Preference Transfer, a new highly-requested feature for multi-tenant enterprise companies in Europe (delivered as a key feature of a multi-millions contract to the major car manufacturer in Europe).
    \item Managed object storage via MinIO for internal asset storage across the platform.
\end{itemize}
}
\cventry{2024}{Software Engineer}{MIC Customs GmbH}{Linz (Austria)}{}{Origin Calculation Platform Team. \textit{\href{mic-cust.com}{mic-cust.com}}
\begin{itemize}
    \item Member of a team of twelve high-skilled developers working on the high-performance origin calculation system (leading software for customers in the automotive industry).
\end{itemize}
}
...
\begin{itemize}
    \item We developed a still-unmatched blockchain wallet for financial institutions (check \href{https://www.linkedin.com/posts/mario-moschetta_fyblo-wallet-deck-ugcPost-7335627159442501632-QFpC?utm_source=share&utm_medium=member_desktop&rcm=ACoAABLltJkBUdf9xp2rIJqurmvAXjMrHIX6YAA}{the technical deck on Linkedin.})
    ...
    \item Head of 3 senior engineers, coordinating the development of the smart contracts in Solidity, the APIs in Typescript, the frontend in Vue.js/Nuxt, and the AWS infrastructure (including extensive use of S3 for asset storage), with mobile app in Capacitor. Managed infra via Terraform and CI\\CD with Github Actions \& Fastlane (mobile) (sold in November 2025).
\end{itemize}
}
...
\cventry{2025-2026}{Co-Founder}{fatturai.it}{}{}{Developed fully with AI an AI-based inovicing agent for the Italian market, in native Swift (iOS)+Typescript (Backend \& MCP)}
\cventry{2024-2025}{Head of Tech}{Movimento Drin Drin}{}{}{I coordinated the technological development for Drin Drin, a newborn political association which in one year onboarded a staff of more than 500 volunteers, and over 15 thousands donating members.}
...
\cvitem{Programming}{Java(very good), Kotlin(very good), Node/Javascript/Typescript(very good), Swift(good), Haskell(good), C\# + ASP.NET(good), Python(very good), PHP(good), Scheme(basic), C/C++(basic), Erlang(basic).}
\cvitem{Database}{Good experience in design and development of databases with MySQL, Oracle SQL, and Microsoft SQL Server.}
\cvitem{CI}{Jenkins(very good), Github Actions(very good), Fastlane(good)}
\cvitem{Cloud \& Storage}{AWS (EC2, S3, Lambda, SQS)(good), MinIO(good), Terraform(good), Docker(very good), Kubernetes(very good), Helm(good)}
\cvitem{Build tools}{Gradle(very good), Maven(good), Swift Module System(good), Vite(very good), Bun(good), Yarn(very good), Pnpm(very good)}
\cvitem{Systems}{Experience in Windows OS, MacOS and Linux (i.e. Ubuntu, Ubuntu Server, CentOS, Alpine, etc.).}
...
\section{Education}
\cventry{2020--2025}{PhD candidate}{Logical Methods in Computer Science at TU Wien}{Vienna}{Austria}{
Details:
\begin{itemize}
    ...
    \item Served as the main maintainer of \texttt{Moonlight} (a Java-based signal monitor) and main developer of \texttt{Webmonitor} (a Kotlin-based web monitor, presented at a flag-ship Software Engineering conference).
...
\cventry{2019--2024}{Publications}{7 peer-reviewed papers}{FORTE, ASE, MEMOCODE, RV, MODELS, SoSyM}{}{Published in the areas of runtime verification, spatio-temporal logic, software modeling, and web engineering. Full list: \href{https://dblp.org/pid/253/6180.html}{dblp.org/pid/253/6180}}
